...
write.csv(ppt.test.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/ppt/", "ppt_test_stations.csv"), row.names = FALSE)
write.csv(ppt.eval.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/ppt/", "ppt_eval_stations.csv"), row.names = FALSE)
...
write.csv(tmax.test.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/tmax/", "tmax_test_stations.csv"), row.names = FALSE)
write.csv(tmax.eval.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/tmax/", "tmax_eval_stations.csv"), row.names = FALSE)
...
write.csv(tmax.test.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/tmin/", "tmin_test_stations.csv"), row.names = FALSE)
write.csv(tmax.eval.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/tmin/", "tmin_eval_stations.csv"), row.names = FALSE)
```
...
for (i in seq_along(months)) {
  ...
  plot(res, main = paste(months[i], "FM4"))
  gans[[i]] <- res
}
```
...
for (i in seq_along(months)) {
  ...
  stn.info.us <- fread(paste(dir, var,"/tmin_test_stations.csv", sep="")) #read in
...
for (i in seq_along(months)) {
  ...
  writeCDF(bias_raster, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Results/foundational_model/tmin/Model4/", months[i], "/spline.nc"), varname='tmin', overwrite = T)

  writeCDF(corrected, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Results/foundational_model/tmin/Model4/", months[i], "/", months[i], "_debias.nc"), varname='tmin', overwrite = T)
}
```
...
stn.data <- stn.info.train[,get("Dec")]
...
map <- leaflet(stn.info.train) %>%
  ...
  # addRasterImage(spec_list[[1]], colors = ColPal.raster, opacity = 1, maxBytes = 12890669, group = "Dec GAN50") %>%
  ...
  addCircleMarkers(lng = ~Long, lat = ~Lat, color="black", fillColor = ~ ColPal.points(stn.data.bias), opacity = 1, fillOpacity = 1, popup = labels, radius=6, weight=2, group = "Stations error") %>%
  addLayersControl(
