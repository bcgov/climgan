...
write.csv(tmin.test.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/tmin/", "tmin_test_stations.csv"), row.names = FALSE)
write.csv(tmin.eval.stations, paste0("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Stations/tmin/", "tmin_eval_stations.csv"), row.names = FALSE)
```
...
# stn.info.test[, (month.abb) := lapply(.SD, function(x) log1p(x)), .SDcols = "Jan"]
