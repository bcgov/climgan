...
```{python}
pred_dir = 'O:/Mosaic_Yukon/Tirion/Results/foundational_model/prec/Model1/sep/spec1/'
pred_path = pred_dir + 'sep_fullregion_masked.nc'
truth_dir = 'C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/PRISM/prec/sep/'
...
fig.suptitle(f"Sep tmax, MAE = %.2f" %MAE)
...
ax.axis('off')
plt.savefig(pred_dir + "sep_full_map_masked.png", bbox_inches='tight', dpi=600)
plt.show()
