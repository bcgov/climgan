...
```{r}
prism_folder <- "C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/PRISM/prec/mar/"
...
# ak <- rast(paste(prism_folder, "ak_tmax_1981_2010.03.asc", sep=""))
# plot(ak)
...
era5_tiles = tile_data(standardized_era5[[3,0,1,2,4,5,6,7,8,9,10,11],...], int(tile_size / scale_factor), int(offset / scale_factor))
era5_test_tiles = tile_data(standardized_era5_test[[3,0,1,2,4,5,6,7,8,9,10,11],...], int(tile_size / scale_factor), int(offset / scale_factor))
