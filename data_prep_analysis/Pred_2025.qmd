...
```{python}
final_pad = torch.load("O:/Mosaic_Yukon/Tirion/Results/Run6/GAN_gen250/Run6_gen250_testregion.pt")
...
results_folder <- "O:/Mosaic_Yukon/Tirion/Results/Run6/GAN_gen250/"
...
writeCDF(res_us, paste0(results_folder, "Run6_gen250_testregion.nc"), varname='tmax', overwrite = T)
```
