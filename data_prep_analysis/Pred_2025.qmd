...
### Add ocean proximity as hrcov: (DONE)
...
```{python}
final_pad = torch.load("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Results/foundational_model/prec/Model4/jun/spec1/debias/jun_fullregion_ext.pt")
...
results_folder <- "C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/Tirion/Results/foundational_model/prec/Model4/jun/spec1/debias/"

data_folder <- "C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/PRISM/prec/jun/"
...
dem_extended <- rast("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/dem/test area prep/dem_stn_train.nc")
...
x <- read.csv("C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/PRISM/prec/standardization.csv")
...
writeCDF(res, paste0(results_folder, "jun_fullregion_ext.nc"), varname='prec', overwrite = T)
...
writeCDF(final, paste0(results_folder, "jun_fullregion_ext_masked.nc"), varname='prec', overwrite = T)
```
