...
final_pad = torch.load("O:/Mosaic_Yukon/Tirion/Results/Run5/GAN_gen250/Run5_gen250_fullregion_sd.pt")

res_np = np.array(final_pad)

plt.close()
fig, ax = plt.subplots()
im = ax.imshow(res_np, cmap = 'gray_r')
...
ax.axis('off')
plt.savefig(pred_dir + "sd_map.png", bbox_inches='tight', dpi=600)
plt.show()
