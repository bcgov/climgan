...
```{r}
# load data
test_metrics <- read.csv("O:/Mosaic_Yukon/Tirion/Results/Run10/test_metrics.csv")
...
```{python}
pred_dir = 'O:/Mosaic_Yukon/Tirion/Results/Run9/tmax/aug/'
pred_path = pred_dir + 'aug_fullregion_masked.nc'
truth_dir = 'C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/PRISM/tmax/aug/'
...
fig.suptitle(f"Aug tmax, MAE = %.2f" %MAE)
...
plt.savefig(pred_dir + "pred_PRISM_test_diff_fullarea_masked.png", dpi = 400)
plt.close()
```
...
ax.axis('off')
plt.savefig(pred_dir + "full_map_masked.png", bbox_inches='tight', dpi=600)
plt.show()
