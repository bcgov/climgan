...
pred_path = pred_dir + 'Run4_gen250_fullregion.nc'
...
final_pad = torch.load("O:/Mosaic_Yukon/Tirion/Results/Run4/GAN_gen250/Run4_gen250_fullregion_setseed.pt")
...
ax.axis('off')
plt.savefig(pred_dir + "full_map_setseed.png", bbox_inches='tight', dpi=600)
plt.show()
