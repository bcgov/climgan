...
```{python}
pred_dir = 'O:/Mosaic_Yukon/Tirion/Results/Run6/GAN_gen250/'
pred_path = pred_dir + 'Run6_gen250_testregion.nc'
...
final_pad = torch.load("O:/Mosaic_Yukon/Tirion/Results/Run6/GAN_gen250/Run6_gen250_fullregion.pt")
