...
```{python}
pred_dir = 'O:/Mosaic_Yukon/Tirion/Results/'
pred_path = pred_dir + 'fullregion_tmax_mar_generator_250_results.nc'
...
# replace variable name (hacky!!)
# truth = truth.rename({'__xarray_dataarray_variable__': 'tmax'})
```
