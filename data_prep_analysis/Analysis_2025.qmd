...
```{r}
# load data
test_metrics <- read.csv("O:/Mosaic_Yukon/Tirion/Results/Run12/test_metrics.csv")
...
```{python}
pred_dir = 'O:/Mosaic_Yukon/Tirion/Results/Run12/mar/'
pred_path = pred_dir + 'mar_fullregion_masked.nc'
truth_dir = 'C:/Users/TGRICE/OneDrive - Government of BC/Documents/GANs/PRISM/tmax/mar/'
truth_path = truth_dir + 'prism_train_coarse_test.nc' 
...
fig.suptitle(f"Feb tmax, MAE = %.2f" %MAE)
