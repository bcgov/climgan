...
```{python}
pred_dir = 'O:/Mosaic_Yukon/Tirion/Results/Run7/GAN_gen250/'
pred_path = pred_dir + 'Run7_gen250_fullregion_masked.nc'
...
ax.axis('off')
plt.savefig(pred_dir + "full_map_masked1.png", bbox_inches='tight', dpi=600)
plt.show()
